...
export default function Socials() {
  ...
  return (
    <div className="socials">
      ...
      <a href="https://www.linkedin.com/in/corentin-renard-web/" target='_blank'><img src={theme === "light-theme" ? LinkedinLight : LinkedinDark} alt="linkedin logo" className="light" /></a>
    </div>
  );
}
