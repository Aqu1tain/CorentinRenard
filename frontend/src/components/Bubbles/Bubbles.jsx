        ...
        bubbles.push(
            <Bubble
                ...
                style={{ // Style of the bubble
                    left: `${precedentAlignement === 'left' ? Math.random() * 70 + "px" : "undefined"}`, // Left position of the bubble when alignement is left
                    right: `${precedentAlignement === 'right' ? Math.random() * 70 + "px" : "undefined"}` // Right position of the bubble when alignement is right
                }}
            />
        );
        precedentColor = precedentColor === 'blue' ? 'green' : 'blue'; // Change the color of the bubble
        precedentType = precedentType === '1' ? '2' : '1'; // Change the type of the bubble
        precedentHeight += 400; // Increment the top position of the bubble
