...
export default function Bubbles() {
    ...
    const numberOfBubbles = Math.ceil(pageHeight / 350);
    ...
    for (let i = 0; i < numberOfBubbles; i++) {
        ...
        precedentColor = precedentColor === 'blue' ? (Math.random() < 0.85 ? 'green' : 'blue') : 'blue'; // Change the color of the bubble
        precedentType = precedentType === '1' ? '2' : '1'; // Change the type of the bubble
        precedentHeight += Math.random() * 50 + 400; // Increment the top position of the bubble
